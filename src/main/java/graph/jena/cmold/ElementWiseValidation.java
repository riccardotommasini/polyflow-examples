...
public class ElementWiseValidation {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        SegmentFactory<Graph, JenaGraphOrBindings> accumulatorContentFactory = new AccumulatorContentFactory<Graph, Graph, JenaGraphOrBindings>(
