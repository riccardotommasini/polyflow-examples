...
import nexmark.operators.r2r.custom.R2Rq5;
...
public class Query5Custom implements Query {
    ...
    public void execute(){
        ...
        */
        ...
        FastLogicalSlidingFactory contentFactory = new FastLogicalSlidingFactory(10);
        ...
        RelationToRelationOperator<List<Entity>> r2r = new R2Rq5(List.of("bidWindow"), "res");
