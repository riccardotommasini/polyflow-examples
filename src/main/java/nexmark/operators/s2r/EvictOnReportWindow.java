...
public class EvictOnReportWindow<I, W, R extends Iterable<?>> implements StreamToRelationOperator<I, W, R> {
    ...
    public EvictOnReportWindow(Time time, String name, ContentFactory<I, W, R> cf, Report report, long width){
    ...
    public void evict(long l) {
        this.activeWindow = new WindowImpl(l, -1);
        this.activeContent = cf.create();
    }
}
